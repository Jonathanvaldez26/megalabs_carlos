                    ...
                    <form method="POST" enctype="multipart/form-data" id="form_programa">
                        <div class="form-group row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="time" class="form-control" id="hora_inicio" name="hora_inicio" placeholder="Horario de incio" required>
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="time" class="form-control" id="hora_fin" name="hora_fin" placeholder="Horario de incio" required>
                            </div>

                        
                            <div class="form-group col-md-4">
                                <label class="control-label col-md-12 col-sm-1 col-xs-12" for="fecha_programa">Fecha Programa <span class="required">*</span></label>
                                <input type="date" class="form-control" id="fecha_programa" name="fecha_programa" placeholder="Fecha Programa" required>
                            </div>

                            <div class="form-group col-md-4">
                                <label class="control-label col-md-12 col-sm-1 col-xs-12" for="url_programa">URL <span class="required">*</span></label>
                                <input type="text" class="form-control" id="url_programa" name="url_programa" placeholder="URL">
                            </div>
