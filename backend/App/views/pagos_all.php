                                        ...
                                        <div class="card up-card">
                                            <div class="row m-4 text-center">
                                                <div class="col-12 m-auto mb-3">
                                                    <div class="bg-gradient-warning avatar avatar-xxl position-relative">
                                                        <span class="fa fa-dollar m-3" style="font-size: xxx-large;"></span>
                                                    </div>
                                                </div>
                                    ...
                                    <a href="/CorteCaja/">
                                        <div class="card up-card">
                                            <div class="row m-4 text-center">
                                                <div class="col-12 m-auto mb-3">
                                                    <div class="bg-gradient-warning avatar avatar-xxl position-relative">
                                                        <span class="fas fa-shopping-bag m-3" style="font-size: xxx-large;"></span>
                                                    </div>
                                                </div>
                                                <div class="col-12 m-auto">
                                                    <div class="col-auto my-auto">
