<?php echo $header; ?>
<title>
    Trabajos Libres - MUSA - GRUPO LAHE
</title>
                                                ...
                                                <table class="align-items-center mb-0 table table-borderless" id="user_list_table">
                                                    <thead class="thead-light">
                                                        <tr>
                                                            ...
                                                            <th class="text-uppercase text-secondary text-center text-xxs font-weight-bolder opacity-7">Trabajo</th>
                                                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Archivo</th>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">
                        Asistente para Crear Trabajos Libres
                    </h5>
                ...
                <div class="modal-body">
                    <p style="font-size: 12px">A continuación ingrese los datos del trabajo.</p>
                    <hr>
                    <form method="POST" enctype="multipart/form-data" id="form_trabajos">
                        <div class="form-group row">
                            <div class="form-group col-md-4">
                                <label class="control-label col-md-12 col-sm-1 col-xs-12" for="titulo">Titulo <span class="required">*</span></label>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" id="autor" name="autor" placeholder="Autor" require>
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                <label class="control-label col-md-12 col-sm-1 col-xs-12" for="grupo">Grupo <span class="required">*</span></label>
                            ...
                            <div class="form-group col-md-4">
                                <label class="control-label col-md-12 col-sm-1 col-xs-12" for="no_poster">No. Poster <span class="required">*</span></label>
                                <input type="number" class="form-control" id="no_poster" name="no_poster" placeholder="Numero de poster" require>
                            </div>
                           
                           <div class="form-group col-md-4">
                                <label class="control-label col-md-12 col-sm-1 col-xs-12" for="pdf">Docuemnto <span class="required">*</span></label>
                                <input type="file" class="form-control" id="pdf" name="pdf" accept="application/pdf" require>
                            </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#trabajos a').addClass('active');
        $('#trabajos .fa-users').addClass('text-white');
        ...
        $("#form_trabajos").on("submit", function(event) {
            event.preventDefault();
            var formData = new FormData(document.getElementById("form_trabajos"));

            for (var value of formData.values()) {
                console.log(value);
            }
            $.ajax({
                url: "/TrabajosLibres/saveTrabajo",
                type: "POST",
                data: formData,
                contentType: false,
                processData: false,
                ...
                success: function(respuesta) {
                    ...
                    if (respuesta == 'success') {
                        Swal.fire("¡Trabajo guardado correctamente!", "", "success").
                        then((value) => {
                            window.location.reload();
                        });
                    } else {
                        Swal.fire("¡Hubo un error guardar el Trabajo!", "", "warning").
                        then((value) => {
                            window.location.reload();
                        });
                    }
