                                        ...
                                        <form class="form-inline my-2 my-lg-0" action="/Usuarios/Usuario" method="post">
                                            <div class="row">
                                                <div class="col-12 col-md-12">
                                                    <input class="form-control mr-sm-2" style="font-size: 35px;" autofocus type="search" id="search" name="search" placeholder="Ej. Adrian Segura Becerra - XaS6cr" aria-label="Search" value="<?php echo $search; ?>">
                                                </div>
